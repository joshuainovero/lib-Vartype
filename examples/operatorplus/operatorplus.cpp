...
int main(){
    ...
    vartype str1 = "randomword";
    vartype str2 = "worstrandomword";
    vartype str3 = "Joshua";
    std::string cppStr = "wasup ";
    char cppChar = 's';
    std::cout << "(str1)'" << str1 << "' + " << "(str2)'" << str2 << "' = " << str1 + str2 << std::endl;
    std::cout << "(str3)'" << str3 << "' + " << "' Inovero'" << " = " << str3 + " Inovero" << std::endl;
    std::cout << "(cppStr)'" + cppStr + "' + " << "(str3)'" << str3 << "' = " << cppStr + str3 << std::endl;
    std::cout << "(str1)'" + str1 << "' + " << "(cppChar)'" << cppChar << "' = " << str1 + cppChar << std::endl << std::endl;
    return 0;
}